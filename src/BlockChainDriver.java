...
public class BlockChainDriver {
	 ...
	 */
	private static void parseInput(BlockChain bc, UserMap users, Scanner s, String cmd)
	...
	/**
	 * The beginning of the program, including welcoming the user and activating the
	 * blockchain loop
	 *
